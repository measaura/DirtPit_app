...
const mtb = [
  ...
  },
  {
    ...
    "data": [
			...
			{
				"contact_no": "019-3752444", 
				"in_charge": "Nan", 
				"email": "nanstarway@hotmail.com", 
				"retail_name": "NANSTARWAY BICYCLE SHOP", 
				"city": "KUALA SELANGOR, SELANGOR", 
				"address": "32, JALAN BENDAHARA 1, TAMAN BENDAHARA, 45000 KUALA SELANGOR, SELANGOR", 
				"store_id": 9, 
				"dealer_name": "NANSTARWAY BICYCLE SHOP"
			}
    ]
  }, 
  {
...
const mx = [
  {
    ...
    "data": [
			{
				"contact_no": "012-2771770", 
				"in_charge": "OKB", 
				"email": "jayhan@mfg.com.my", 
				"retail_name": "MOST FUN GYM", 
				"city": "PENCHALA, KUALA LUMPUR", 
				"address": "2734, JALAN DAMANSARA, KAMPUNG SUNGAI PERNCHALA, 60000 KUALA LUMPUR", 
				"store_id": 1, 
				"dealer_name": "MOST FUN GYM"
			} 
		]
  }, 
  {
    ...
    "data": [
			{
				"contact_no": "019-5553365", 
				"in_charge": "TOMMY SOO ", 
				"email": "winds44@live.com", 
				"retail_name": "GOGOMART TRADING", 
				"city": "PERAI, PENANG ", 
				"address": "GOGOMART. 5, SIGNATURE AVENUE, JALAN LESTARI (JALAN BARU) 13700 PENANG", 
				"store_id": 2, 
				"dealer_name": "GOGOMART TRADING - PERAI"
			}, 
			{
				"contact_no": "016-41811160", 
				"in_charge": "KITTY", 
				"email": "kittyleesherco@gmail.com", 
				"retail_name": "PLANET CYCLE SUPERBIKE CENTRE SDN. BHD.", 
				"city": "GEORGETOWN, PENANG", 
				"address": "363K JLN SULTAN AZLAN SHAH 11700", 
				"store_id": 3, 
				"dealer_name": "PLANET CYCLES"
			}, 
			{
				"in_charge": "TATT", 
				"retail_name": "HOCK LEE MOTOR", 
				"city": "BUTTERWORTH, PENANG", 
				"address": "1518, JALAN SUNGAI DUA, JALAN MERBAU KUDUNG, 13800", 
				"store_id": 4, 
				"dealer_name": "HOCK LEE MOTOR"
			},
    ]
  }, 
  {
    ...
    "data": [
      {
				"contact_no": "016-3226300", 
				"in_charge": "LESTER GOH", 
				"email": "SAWADEEKAP9@GMAIL.COM", 
				"retail_name": "M-BIKE", 
				"city": "KOTA KINABALU, SABAH ", 
				"address": "G-G-32A,BLOCK G, GROUND FLOOR, KAPITAL 5,  LORONG INANAM SENTRAL 3, 88450", 
				"store_id": 5, 
				"dealer_name": "M-BIKE"
			}
    ]
  }, 
  {
    ...
    "data": [
      {
				"contact_no": "013-828 9907", 
				"in_charge": "SILAS", 
				"email": "silas@trumoto.my", 
				"retail_name": "TRUMOTO - MOTORCYCLE TRAINING & TOURS", 
				"city": "KUCHING, SARAWAK", 
				"address": "SL15, HAKKA AVENUE, 5TH MILE", 
				"store_id": 6, 
				"dealer_name": "TRUMOTO SDN BHD"
			}
    ]
  }
];
...
// 		if (this.state.dealersType == 'mx') {
// 			this.setState({
// 				dataSource: mx,
// 				loading: false,
// 			})
// 		}else if (this.state.dealersType == 'mtb') {
// 			this.setState({ 
// 				dataSource: mtb,
// 				loading: false,
// 			})
